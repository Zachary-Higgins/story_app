    ...
    <div className="relative space-y-10">
      <div className="rounded-3xl bg-gradient-to-br from-surface/90 via-elevated/80 to-surface/90 p-8 shadow-2xl md:p-12">
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-accent/10 bg-elevated/70 shadow-soft">
            <img src={homeConfig.hero.image} alt={homeConfig.hero.imageAlt} className="h-full w-full object-cover" />
